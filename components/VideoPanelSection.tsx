export default function VideoPanelSection() {
  return (
    <section
      ...
      className="flex flex-col px-[4vw] w-screen min-h-screen pt-[19vh] pb-[10vh]"
    >
      {/* Animated headings */}
      <div className="about-headers pb-[10vh]">
        <div className="animated-h1-container overflow-hidden w-full whitespace-nowrap">
          <h1
            id="h1-topline"
            className="text-[9vw] mb-0 inline-block invisible"
          >
            BEYOND VISIONS
          </h1>
        </div>
      ...
      <div className="flex flex-col items-end pb-[10vh]">
        <p className="w-[40%] mb-4 text-sm leading-relaxed text-gray-700">
